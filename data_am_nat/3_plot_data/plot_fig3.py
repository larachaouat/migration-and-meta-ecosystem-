...
# Short description:
# Plot Fig.3 — reads coexistence result CSVs for different parameter grids,
...
path = os.path.normpath(os.path.join(_script_dir, '..', '2_data_csv', 'fig3_csv'))
...
set = [ 
    ['amp1', 'F' ,np.linspace(0,1,B)*100, np.linspace(0.1,.9,B)*100],
]
